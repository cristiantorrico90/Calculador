# -*- coding: utf-8 -*-
  ...
  #definimos una funcion con el nombre decHex y le asignamos como parametro los valores ingresados en decimal
def decHex(decimal):
    ...
    return ("El resultado en número Hexadecimal es: " + cadena)